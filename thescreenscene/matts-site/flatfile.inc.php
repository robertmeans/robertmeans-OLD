...
echo '<html>';
echo '<head><title>Login Manager</title><link rel="stylesheet" href="_css/styles.css?' . time() . '"></head>';

echo '<body class="login-body">';
echo '<div class="login-wrapper">';
// logout link
echo '<a class="login-logout-save" href="manager.php?logout=1">Logout</a>';
echo '<hr />';

// protection string
echo '<h1>The Law Firm of Matthew Beach, LLC<h1>';
echo '<h3>https://secure.lawpay.com/pages/mbeachlegal/trust</h3><br><br>';
echo '<form method="post">';
echo '<table>'."\n";

// output header
echo '<tr style="background: #ccc; font-family: Tahoma, Verdana, sans-serif;">';
...
echo '<tr><td colspan=255 align=center><input type="submit" class="login-save-btn" name="submit" value="Save Changes and Delete Marked"></td></tr>';
echo '</table>';
echo "</form>
