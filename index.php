<?php $thisPage="home"; ?>
<?php include '_includes/intro_header.php'; ?>       
<?php include '_includes/nav.php'; ?>
        ...
        <div class="promo_container">
        	...
        	<div class="promo one">
            	<div class="content">
                <a href="http://www.myscreenscene.com" target="_blank"><img src="_images/promo_1.jpg" width="60" height="60" alt="My Screen Scene" /></a>
            ...
            <div class="promo two">
            	<div class="content">
                <a href="websites.php"><img src="_images/promo_2.jpg" width="60" height="60" alt="Website Projects" /></a>            
                    <h3>Websites</h3>
            ...
            <div class="promo three">
                <div class="content">
                <a href="video.php"><img src="_images/promo_3.jpg" width="60" height="60" alt="Videos" /></a>            	
                    <h3>Video</h3>
